        ...
        <div className="footer-grid">
          ...
          <div style={styles.column}>
            ...
            <div style={styles.contactList} role="list" aria-label={t('footer.contactHeading')}>
              ...
              <div style={styles.contactItem}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" style={styles.contactIcon} aria-hidden="true">
                ...
                <a href="https://wa.me/353831257105" target="_blank" rel="noopener noreferrer" style={styles.contactLink}>{t('footer.whatsappNumber')}</a>
              </div>
              <div style={styles.contactItem}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={styles.contactIcon} aria-hidden="true">
